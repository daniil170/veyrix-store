...
const Header = () => {
  ...
  // Генерируем базовый путь для картинок из public
  ...
  return (
    <>
      ...
      >
        <div className="max-w-[1440px] mx-auto px-6 py-8 md:py-10 flex items-center justify-between">
          <button
            ...
            className="flex flex-col gap-1.5 group cursor-pointer w-10 z-10"
          >
      ...
      {/* SIDE MENU PANEL */}
      <div
        className={`fixed top-0 left-0 h-full w-full max-w-[400px] z-[70] bg-black transition-transform duration-700 ease-[cubic-bezier(0.19,1,0.22,1)] flex flex-col ${
      ...
      >
        ...
        <div className="p-10 flex flex-col gap-10">
          <div className="flex justify-between items-start">
            ...
            <button
              onClick={() => setIsMenuOpen(false)}
              className="text-white hover:rotate-90 transition-transform duration-500 p-2"
            >
              <svg
                width="20"
                height="20"
        ...
        <div className="p-12 space-y-8">
          <a
            href="#"
            className="text-white opacity-40 hover:opacity-100 transition-opacity block"
          >
